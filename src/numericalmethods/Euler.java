...
public class Euler
{
    ...
    public static double[] integrate(double x_0, double x_f, double[] y_0, double delx, int maxIt, SetOfODEs f)
    {
        ...
        //values of x and y[]. This is accomplished through the Function object's calculateDelT method
        ...
        while(x<=x_f && i<=maxIt)
        {
            ...
            // array returned by calculateDelT, because it is simply a temporary placeholder (local array) for this returned array
            //and because the array it is assigned to in the client's calculateDelT is also a local one
