...
public class Driver1 {
    ...
    public static void processSpeciesInput(){
        //create species object for each of the species inputted
            //if species not one of the available elements throw error
    }
    public static void processReactionInput(){
        //determine number of reactions
            //loop through the reactions in
        //determine number of elements present in the reaction
        //
    }

    public static void processReactorInput(){
        //
    }
