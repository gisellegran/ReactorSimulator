...
public class PFRDesigner implements SetOfODEs {
    ...
    public PFR returnVForTargetFlow(Specie s, double targetF, Stream input, ReactionSet rxns,
      ...
      //get inlet FlowRates
        ...
        if (xf>100000){
            throw new IllegalArgumentException("Maximum iteration is reached");
        }
    ...
    protected Stream getStreamFromY(double[] y) {
        ...
        if (y == null) {throw new IllegalArgumentException("y parameter is null");
        }
